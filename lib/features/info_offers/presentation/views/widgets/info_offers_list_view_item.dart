...
class InfoOffersListViewItem extends StatefulWidget {
  final int index;
  ...
  @override
  State<InfoOffersListViewItem> createState() => _InfoOffersListViewItemState();
}

class _InfoOffersListViewItemState extends State<InfoOffersListViewItem> {
