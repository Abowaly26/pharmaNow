    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 32),
          _buildModernPaymentOption('Apple Pay', Icons.phone_iphone, 0),
          SizedBox(height: 16),
          _buildModernPaymentOption('MasterCard', Icons.credit_card, 1),
          SizedBox(height: 16),
          _buildModernPaymentOption('PayPal', Icons.account_balance_wallet, 2),
        ],
      ),
    );
  }
